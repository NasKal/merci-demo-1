...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#FDF8F5]">
      ...
      {/* Hero Section */}
      <div className="relative h-screen md:h-[80vh] bg-cover bg-center" style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1578985545062-69928b1d9587?auto=format&fit=crop&q=80&w=2000")' }}>
        <div className="absolute inset-0 bg-black bg-opacity-40">
          <div className="container mx-auto px-6 h-full flex items-center">
            <motion.div className="text-white max-w-2xl">
              <motion.h1 className="text-5xl md:text-6xl font-serif mb-4">Καλώς Ορίσατε στο Merci</motion.h1>
              <motion.p className="text-2xl md:text-3xl font-light mb-8">Γλυκές Απολαύσεις Κάθε Μέρα!</motion.p>
              <motion.p className="text-xl mb-8">Βρισκόμαστε στην Βάρδα, Ηλείας και φτιάχνουμε φρέσκα, χειροποίητα γλυκά, τούρτες και επιδόρπια καθημερινά.</motion.p>
              <motion.a href="https://maps.app.goo.gl/WSDAXG2DmBYvDhjSA" target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-6 py-3 bg-[#D4A373] text-white rounded-full hover:bg-[#BC8C5F] transition-colors">
